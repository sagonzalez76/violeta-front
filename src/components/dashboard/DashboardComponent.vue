            ...
            <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
                    ...
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="sidebarMenuLabel">SOS Violeta</h5>
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <router-link to="/dashboard" class="nav-link d-flex align-items-center gap-2"
                                    :class="{ active: isActive('/dashboard') }" aria-current="page" href="#">
                                    <svg class="bi">
                            ...
                            <li class="nav-item">
                                <router-link to="/dashboard/victimarios"
                                    class="nav-link d-flex align-items-center gap-2"
                                    :class="{ active: isActive('/dashboard/victimarios') }" href="#">
                                    <svg class="bi">
                        ...
                        <ul class="nav flex-column mb-auto">
                            ...
                            <li class="nav-item">
                                <router-link to="/" class="nav-link d-flex align-items-center gap-2" href="#">
                                    <svg class="bi">
